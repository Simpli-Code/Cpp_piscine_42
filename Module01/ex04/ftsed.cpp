...
FtSed::FtSed(const std::string &filename, const std::string &s1, const std::string &s2) : _filename(filename), _s1(s1), _s2(s2) {}

std::string FtSed::replaceString(const std::string &str) const
{
	size_t end;
	std::string newStr;
